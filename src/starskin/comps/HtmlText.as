...
package starskin.comps
{
	...
	public class HtmlText extends HtmlTextBase
	{
		...
		override public function setActualSize( w:Number, h:Number ):void
		{
			...
			labelDisplay.$width = w - paddingL - paddingR;

			if( isNaN( explicitHeight ))
			{
				newHeight = labelDisplay.textHeight + paddingT + paddingB;
			}
			else
			{
				newHeight -= paddingT - paddingB;
			}
		...
		override protected function updateDisplayList( unscaledWidth:Number, unscaledHeight:Number ):void
		{
			...
			{
				unscaledTextHeight = labelDisplay.textHeight + paddingT + paddingB;
			}
			else
			{
				unscaledTextHeight = unscaledHeight - paddingT - paddingB;
			}
		...
		override protected function getTextFieldAutoSize():String
		{
			switch( _textAlign )
			{
